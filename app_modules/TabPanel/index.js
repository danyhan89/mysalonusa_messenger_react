...
class TabPanel extends React.Component {
  ...
  render() {
    ...
    return <div {...cleanupProps(props, TabPanel.propTypes)} className={join(props.className, 'flex flex-column', styles.tabPanel)}>
      ...
      <div style={props.tabBodyStyle} className={join(props.tabBodyClassName, 'flex flex-column', styles.tabBody)}>
        {activeTab}
      </div>
    </div>
  ...
  getActiveIndex() {
    ...
    const activeIndex = props.activeIndex !== undefined ? props.activeIndex : state.activeIndex
