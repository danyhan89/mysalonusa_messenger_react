...
const Box = ({ to, title, children, style, className }) => {
  return <Link to={to} style={{ flex: 1, ...style }} className={join(
    ...
    <div className={`${styles.textLayer} pa3 `}>
      <Link to={to} className={`${styles.boxTitle} b dib f4 ttu mb3`}>{title}</Link>
  ...
  render() {
    ...
    return (
      <div className={`${styles.dashboard} pa3`}>
        ...
        <div className={"mb3 fw3 f3"}> <Label values={{ community: getCommunity(community).label }}>dashboardWelcome</Label></div>
        <div className="flex flex-wrap">
          <Box to={`${url}/jobs`} title="Jobs" style={{
            //            background: 'url("https://s3.us-east-2.amazonaws.com/mysalonusa/uploads/banner_cards/find_jobs2.jpg") center/cover'
            background: 'url("https://s3.us-east-2.amazonaws.com/mysalonusa/uploads/banner_cards/post_jobs.jpg") center/cover'
          }}>

            <Label values={{ count: <b>54</b> }}>
              xrecentjobs
            </Label>
            <br />
            <Label values={{ period: <b>2</b> }}>
              inperiod
            </Label>

          </Box>
          <Box to={`${url}/jobs`} title="Business on sale" style={{ background: 'url("https://s3.us-east-2.amazonaws.com/mysalonusa/uploads/banner_cards/Business_On_Sale_2.jpg") center/cover' }}>
            <Label values={{ count: <b>4</b> }}>
              xrecentjobs
            </Label>
            <br />
            <Label values={{ period: <b>3</b> }}>
              inperiod
            </Label>
          </Box>
          ...
          <Box to={`${url}/jobs`} title="Post a job" style={{
            background: 'url("https://s3.us-east-2.amazonaws.com/mysalonusa/uploads/banner_cards/find_jobs2.jpg") center/cover',
